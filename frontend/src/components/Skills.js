  ...
  return (
    <div className="skills-page">
      ...
      <div>
        ...
        <img
          className="skill-logo"
          src="https://cdn.iconscout.com/icon/free/png-256/css-37-226088.png"
          alt="css"
        />
        <img
          className="skill-logo"
        ...
        <img
          className="skill-logo"
          src="https://docs.microsoft.com/cs-cz/windows/images/nextjs-logo.png"
          alt="next js"
        />
        <img
          className="skill-logo"
          src="https://antman.info/images/news/logo.bootstrap.png"
          alt="bootstrap"
        />
        <img
          className="skill-logo"
        ...
        <img
          className="skill-logo"
          src="https://cdn.iconscout.com/icon/free/png-256/express-8-1175029.png"
          alt="express"
        />
        <img
          className="skill-logo"
        ...
        <img
          className="skill-logo"
          src="https://cdn.iconscout.com/icon/free/png-256/aws-1869025-1583149.png"
          alt="aws"
        />
        <img
          className="skill-logo"
          src="https://s28309.pcdn.co/wp-content/themes/321-web-marketing/assets/images/api-logo-256.png"
          alt="rest api"
        />
        <img
          className="skill-logo"
